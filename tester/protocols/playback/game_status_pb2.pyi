...
class GameStatus(_message.Message):
    __slots__ = ("source_id", "description", "timestamp", "match_type", "home_team", "away_team", "is_home_team_on_positive_half", "game_stage", "game_stage_time_left", "total_commands_issued", "command_issued_timestamp", "command", "next_command", "game_events", "game_events_proposals")
    ...
    IS_HOME_TEAM_ON_POSITIVE_HALF_FIELD_NUMBER: _ClassVar[int]
    ...
    is_home_team_on_positive_half: bool
