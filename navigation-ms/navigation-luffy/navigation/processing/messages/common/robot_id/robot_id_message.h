#ifndef NAVIGATION_PROCESSING_MESSAGES_COMMON_ROBOT_ID_H
#define NAVIGATION_PROCESSING_MESSAGES_COMMON_ROBOT_ID_H
...
#endif // NAVIGATION_PROCESSING_MESSAGES_COMMON_ROBOT_ID_H
