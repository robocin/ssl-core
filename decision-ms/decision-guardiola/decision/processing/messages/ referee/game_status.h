...
class TeamMessage {
 public:
  ...
  std::vector<google::protobuf::Duration> time_to_expire_active_yellow_cards;
  ...
  std::optional<google::protobuf::Duration> robot_substitution_time_left;
};

class GameEventsProposal {
 public:
  explicit GameEventsProposal(std::string proposal_id,
                              const std::vector<GameEventMessage>& game_events,
                              bool was_accepted);
...
class GameStatusMessage {
 public:
  ...
  std::vector<GameEventMessage> game_events;
  std::vector<GameEventsProposal> game_events_proposals;
};
} // namespace decision
