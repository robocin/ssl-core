#ifndef BEHAVIOR_PROCESSING_MESSAGES_COMMON_ROBOT_KICK_KICK_COMMAND_H
#define BEHAVIOR_PROCESSING_MESSAGES_COMMON_ROBOT_KICK_KICK_COMMAND_H
...
#endif // BEHAVIOR_PROCESSING_MESSAGES_COMMON_ROBOT_KICK_KICK_COMMAND_H
